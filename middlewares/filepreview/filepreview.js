...
module.exports = {
   ...
   */
  generateAsync: (input_original, output, options = {}) =>
    new Promise((resolve, reject) => {
      let input = input_original;
      if (!fs.existsSync(input))
        reject({
          error:
            "file doesnot exist please make sure you are using the right path",
        });
          ...
          if (fileType == "other") {
            ...
            child_process.execFile(
              ...
              function (error) {
                ...
                //     "-resize",
                //     "500x800",
                //     "/Users/matt.outen/Desktop/projects/texas-math-central/middlewares/filepreview/documents/pdfs/example.pdf[0]",
                //     "/Users/matt.outen/Desktop/projects/texas-math-central/middlewares/filepreview/documents/example-widthxheight.jpg";

                child_process.execFile("convert", convertOtherArgs, function (
                  error
                ) {
                  if (error) reject(error);
